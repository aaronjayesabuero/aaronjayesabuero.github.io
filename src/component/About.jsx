...
const infoItems = [
	...
	},
	{
		icon: <Mail />,
		label: "Email",
		value: "aaronjayesabuero@gmail.com",
	},
];
			...
			>
				<div className="mx-auto w-full max-w-[1200px]">
					<div className="fade-in">
						...
						<h2 className="mb-6 text-[clamp(1rem,2.1vw,2rem)] font-bold leading-[1.1] tracking-tight">
							Get to know me
						</h2>
					</div>

					<div className="mt-6 grid grid-cols-2 items-start gap-16 max-lg:grid-cols-1 max-lg:gap-10">
						<div className="fade-in fade-in-delay-1 flex flex-col gap-6">
							<p className="text-base leading-7 text-[var(--text-secondary)]">
								...
								and user-friendly web applications. My journey in tech started
								with a love for problem-solving and a curiosity for how things
								work.
							</p>
							<p className="text-base leading-7 text-[var(--text-secondary)]">
								I'm always eager to learn new technologies and improve my
								skills. When I'm not coding, I enjoy reading tech blogs,
								exploring new frameworks, and working on personal projects that
